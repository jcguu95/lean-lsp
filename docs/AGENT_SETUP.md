# Agent Setup for LEAN Interaction

> **Note:** This guide covers a specific setup for using `lean-lsp` with a Docker-based AI agent. For general information about `lean-lsp`, please see the main [README.md](../README.md).
